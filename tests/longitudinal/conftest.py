"""Apply the `longitudinal` marker to every test collected under this directory.

Directory-level marking (test-organization.md §3): a test's *location* declares its
execution profile, so `-m longitudinal` selects this whole category without per-file decoration.
