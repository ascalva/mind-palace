...
in troughs, maintains the graph, and produces ranked *interpretations* of the owner's mind —
...
graph** that everything feeds. Source-specialists feed *their own provenance pool* — authored
...
health of the graph" is the **Curator** (built, Phase 7), operating *within* provenance
boundaries.
...
- **R2 — utility telemetry.** Track per-dream usage as a *separate* axis; surface ranking uses
