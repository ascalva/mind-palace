...
- Recommendations land in the verdict store's inbox as annotations. Promotion spends only owner verdicts. Adjudicator selection taking effect without a verdict would be optimization over the system's own outputs — self-modification, requiring the separate gate. The adjudicator is a clerk, not a proxy.
