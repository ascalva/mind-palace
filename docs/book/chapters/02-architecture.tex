...
\begin{figure}[t]
  \centering
  \input{figures/enforcement-ladder}
...
\begin{figure}[t]
  \centering
  \input{figures/plane-principals}
...
manual names it and withholds its content; \artifact{finding-0183} records the gap
...
\begin{itemize}[leftmargin=*]
  \item \textbf{The import firewall} proves that exactly two audited files touch
    ...
    (\artifact{finding-0103}; \artifact{finding-0185}) is not yet at zero:\\
...
\artifact{finding-0183} records the gap and proposes the note for ratification.
...
be. \artifact{finding-0184} records it.
