...
| 4 | Ops | sweep_orphans on real stranded 300246; the rate block telling healthy backfill from wedge; `start` fail-closed vs live supervisor (bp-105; demo = its journal Ckpt 4) | PENDING |
